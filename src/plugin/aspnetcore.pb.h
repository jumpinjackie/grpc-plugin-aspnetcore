...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_aspnetcore_2eproto_metadata_getter(int index);
namespace aspnet {
namespace core {
class MvcRoute;
...
inline bool HttpInputSource_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, HttpInputSource* value) {
...
class MvcRoute PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~MvcRoute();
  explicit constexpr MvcRoute(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_aspnetcore_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void MvcRoute::_internal_set_custom_method_body_template(const std::string& value) {
  ...
  custom_method_body_template_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void MvcRoute::set_custom_method_body_template(const char* value) {
  ...
  custom_method_body_template_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:aspnet.core.MvcRoute.custom_method_body_template)
}
inline void MvcRoute::set_custom_method_body_template(const char* value,
    size_t size) {
  
  custom_method_body_template_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* MvcRoute::_internal_mutable_custom_method_body_template() {
  ...
  return custom_method_body_template_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
