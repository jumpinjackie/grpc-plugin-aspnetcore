...
enum HttpMethod {
  ...
  HttpMethod_Put = 2,
  HttpMethod_Delete = 3,
  HttpMethod_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  HttpMethod_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
enum HttpInputSource {
  ...
  HttpInputSource_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::min(),
  HttpInputSource_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::google::protobuf::int32>::max()
};
...
class MvcRoute :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:aspnet.core.MvcRoute) */ {
 public:
  MvcRoute();
  virtual ~MvcRoute();
