...
%PROTOBUF_TOOLS%\protoc.exe -Iproto -I%PROTOBUF_INCLUDE% --plugin=protoc-gen-example=%CD%\build\x64-Debug\out\bin\protoc_plugin_aspnetcore.exe proto/Services.proto --example_out=generate_project=1:src/gateway